...
for n, model in enumerate(models):
    ...
    ax12.plot(v2, g2, color=cmap(norm(n)))
    if n == 0:
        ax12.scatter(exp_deact_v, exp_deact_i, s=100, facecolors='none', edgecolors='red', marker='o')
...
if args.show == True:
    ...
    filename1 = 'All_figures/Biomarkers-inactivation-all-models-compare-fit-' + protocol_str + '-iid-noise'
    filename2 = 'All_figures/Inactivation-all-models-compare-fit-' + protocol_str + '-iid-noise'
