...
ax1.legend(['Model', 'Expt.'], loc='best', fontsize=8)
if args.grid:
    ax1.grid(True)
ax2 = fig.add_subplot(1,2,2)
pl.title('I-V relation', fontsize=10)
ax2.set_xlabel('Voltage (mV)')
ax2.plot(v2, g2n, c='red', linestyle='--', lw=1)
pl.scatter(exp_iv_v, exp_iv_in, s=36, facecolors='none', edgecolors='#1f77b4', marker='o')
if args.grid:
    ax2.grid(True)
pl.tight_layout()
if args.show == True:
    ...
    filename = 'All_figures/Biomarkers-activation-model-' + model_str + '-fit-' + protocol_str + '-paper'
...
if args.show == True:
    ...
    filename = 'Activation-model-' + model_str + '-fit-' + protocol_str + '-paper'
