...
pl.title('Deactivation')
ax2.set_xlabel('Voltage (mV)')
ax2.set_ylabel(r'$\tau$ (ms)')
ax2.plot(v2, g2, c='dodgerblue', linestyle='--')
pl.scatter(exp_deact_v,exp_deact_i, s=100, facecolors='none', edgecolors='limegreen',marker='o')
ax2.grid(True)
ax2.set_yscale('log')
pl.tight_layout()
if args.show == True:
    ...
    filename = 'All_figures/Biomarkers-inactivation-model-' + model_str + '-fit-' + protocol_str + '-iid-noise'
...
if args.show == True:
    ...
    filename = 'Inactivation-model-' + model_str + '-fit-' + protocol_str + '-iid-noise'
