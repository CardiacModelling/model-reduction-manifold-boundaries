...
for n, model in enumerate(models):
    ...
    ax12.plot(v2, g2n, linestyle=linestyles[n], color=colors[n], lw=1)
    if n == 0:
        ax12.scatter(exp_iv_v, exp_iv_in, s=36, facecolors='none', edgecolors='#1f77b4', marker='o')
...
if args.show == True:
    ...
    filename1 = 'All_figures/Biomarkers-activation-models-compare-fit-' + protocol_str + '-iid-noise'
    filename2 = 'All_figures/Activation-models-compare-fit-' + protocol_str + '-iid-noise'
