...
***"Ion channel model reduction using manifold boundaries".*** (Under review). Whittaker, D. G., Wang, J., Shuttleworth, J. G., Venkateshappa, R., Kemp, J. M., Claydon, T. W., Mirams, G. R.
